 function Membrane_parameter = Call_MembraneSolution(J1, S12, A, f_feed, P_feed, y_feed1, N, t_feed)
    y_feed2=1-y_feed1;
    [f_c3h6_resd, f_c3h8_resd, f_c3h6_perm, f_c3h8_perm, P_resdN] =  Solve_Mem_Op(J1, S12, A, f_feed, P_feed, y_feed1, y_feed2, N, t_feed);
