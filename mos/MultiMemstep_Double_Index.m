...
%     
     ...
     xlswrite('C:\Users\chang\OneDrive\Documents\Graduate level documents\Master thesis\gnh use\Two step Mem 1.xlsx',Area                ,'sheet5',['A',num2str(Index),':B',num2str(Index)]); 
     xlswrite('C:\Users\chang\OneDrive\Documents\Graduate level documents\Master thesis\gnh use\Two step Mem 1.xlsx',GPU_Mem             ,'sheet5',['E',num2str(Index),':F',num2str(Index)]); 
     xlswrite('C:\Users\chang\OneDrive\Documents\Graduate level documents\Master thesis\gnh use\Two step Mem 1.xlsx',S_Mem               ,'sheet5',['C',num2str(Index),':D',num2str(Index)]); 
     xlswrite('C:\Users\chang\OneDrive\Documents\Graduate level documents\Master thesis\gnh use\Two step Mem 1.xlsx',P_resd_out          ,'sheet5',['G',num2str(Index),':H',num2str(Index)]); 
     xlswrite('C:\Users\chang\OneDrive\Documents\Graduate level documents\Master thesis\gnh use\Two step Mem 1.xlsx',Outputdata_PR       ,'sheet5',['I',num2str(Index),':J',num2str(Index)]); 
     Index = Index + 1;
